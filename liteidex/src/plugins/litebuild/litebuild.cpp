...
QMap<QString,QString> LiteBuild::buildEnvMap(LiteApi::IBuild *build) const
{
...
void LiteBuild::execAction(const QString &mime, const QString &id)
{
    ...
    QMap<QString,QString> env = buildEnvMap(build);
